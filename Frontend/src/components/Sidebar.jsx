...
export default function Sidebar({ role }) {
  ...
  const userMenu = [
    { to: '/dashboard/katalog', label: 'Katalog', icon: /* svg */ (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const adminMenu = [
    { to: '/dashboard/barang', label: 'Barang', icon: /* svg */ (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
    </svg>) },
    { to: '/dashboard/pengadaan', label: 'Pengadaan', icon: /* svg */ (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    { to: '/dashboard/peminjaman', label: 'Peminjaman', icon: /* svg */ (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
    </svg>) },
    { to: '/dashboard/pengembalian', label: 'Pengembalian', icon: /* svg */ (<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
