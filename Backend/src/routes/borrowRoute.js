...
import { borrowBook, confirmBorrow, getAllBorrow, returnBook, getMyBorrowHistory } from "../controllers/borrowController.js"
...
route.post("/confirm/:borrowId", verifyToken, isAdmin, confirmBorrow);  // ← ADD THIS LINE
